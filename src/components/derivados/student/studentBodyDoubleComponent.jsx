            ...
            <div className="a2">
              ...
              <option key={option.value} value={option.value}>{option.value}</option>
                    ...
                    <div className="d2">
                        ...
                        <input className='input-text' type='text' placeholder='Ej: 612 34 56 78' name="phonenumber" id="phonenumber" required onChange={handleChange} value={form ? form.phonenumber : ''}/><input className='input-text' type='text' placeholder='Ej: +34 612 34 56 78'/>
                    </div>
                    <div className="e2">
